    ...
    return (
        <div className='px-4 md:px-8 py-16'>
            ...
            <div className='flex flex-col md:flex-row justify-center md:justify-evenly gap-8'>
                <ProjectCard name="Click & Collect" description="Description for Project 1" githubLink="https://github.com/Harsh-verma24/Click-And-Collect"
                    previewImg='/projects/c&c.png' />
                <ProjectCard name="Web Map" description="Description for Project 1" githubLink="https://github.com/Harsh-verma24/WebMap"
